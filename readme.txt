...
Installing "Gravity Assist" can be done either by searching for "Gravity Assist" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
